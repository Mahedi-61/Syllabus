...
public class AssociateSyllabusForBooks extends Activity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("from").equals("associate_overview_5")) {
            this.keyName = this.id + "associate_quran_tafsir";
            ...
            this.lvSyllabusList.setAdapter(new AdapterForOnlyBooksInAssociate(this, AssociateSyllabus.associateQuranChapterList, AssociateSyllabus.associateQuranTafsirList, this.keyName, this.id));
        }
        if (getIntent().getStringExtra("from").equals("associate_overview_6")) {
            this.keyName = this.id + "associate_hadith_study";
            this.tvSyllabusName.setText("হাদীস  অধ্যয়ন");
            this.tvTotalNo.setText("4");
            this.tvTotalCompleted.setText(new StringBuilder(String.valueOf(AllCompletedNoData.getCompletdNumberForAssociate(this, this.keyName, this.id))).toString());
            this.lvSyllabusList.setAdapter(new AdapterForOnlyBooksInAssociate(this, AssociateSyllabus.associateHadithBooks, AssociateSyllabus.associateHadithWriters, this.keyName, this.id));
        }
