...
public class AdapterForOnlyAloconaInAssociate extends BaseAdapter {
    private ArrayList<String> aloconaList;
    private SharedPreferences associate;
    private Context context;
    private String keyName;

    public AdapterForOnlyAloconaInAssociate(Context context, ArrayList<String> arrayAlocona, String keyName) {
        this.context = context;
        this.aloconaList = arrayAlocona;
        this.keyName = keyName;
        Log.e("allah help me ", keyName);
